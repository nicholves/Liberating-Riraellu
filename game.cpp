...
void Game::Setup(void)
{
    ...
    //Turret* turret = new Turret(glm::vec3(-2.0f, 2.0f, 0.0f), tex_[13], true, 1, 5); //turrets can no longer be individual
